...
# generate plot
cd plots
python3 analyze_spec_results.py --inputs baseline.088_099.txt symbolized.090_096.txt source_asan.040.txt binary_asan.045_046_102.txt bASAN.txt --plot out --pp
