...
# print(f"cd {PATH_SPECPU} && source shrc && runcpu --rebuild --iterations 5 --config final.cfg {final_str}")
# print(f"cd {PATH_SPECPU} && source shrc && runcpu --rebuild --iterations 1 --config superperf.cfg {final_str}")
